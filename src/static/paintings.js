const paintings = [
  {
    ...
    imageUrl: process.env.PUBLIC_URL + "/assets/img/painting-1.jpeg",
    time: 1500,
  },
  {
    title: "Bora Bora",
    ...
    imageUrl: process.env.PUBLIC_URL + "/assets/img/painting-2.jpeg",
    time: 1500,
  },
  {
    title: "Dora",
    description:
      "Shaped lush volcanic island stars in countless South Pacific fantasies. The focal point and best asset of this tropical beauty is its ravishing lagoon in technicolor turquoise. Fish, turtles, sharks, and rays swim in the clear waters.",
    imageUrl: process.env.PUBLIC_URL + "/assets/img/painting-3.jpeg",
    time: 1500,
  },
  {
    title: "Green",
